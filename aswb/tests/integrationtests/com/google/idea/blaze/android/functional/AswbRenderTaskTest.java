...
public class AswbRenderTaskTest extends BlazeAndroidIntegrationTestCase {
  ...
  @After
  public void tearDownRenderTaskTest() {
  ...
  private static void withRenderTask(Module module, VirtualFile file, Consumer<RenderTask> c)
      throws Exception {
  ...
  public static URL getClassLocation(Class<?> clazz) {
    String resName = clazz.getName().replace('.', '/');
    URL location = clazz.getResource("/" + resName + ".class");
    return location;
  }
}
